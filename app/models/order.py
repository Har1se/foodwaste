...
class Order(SQLModel, table=True):
    ...
    status: OrderStatus = Field(
        ...
        sa_column=Column(sa.Enum(OrderStatus), nullable=False, server_default="pending"),
    )
...
class Payment(SQLModel, table=True):
    ...
    status: PaymentStatus = Field(
        ...
        sa_column=Column(sa.Enum(PaymentStatus), nullable=False, server_default="pending"),
    )
