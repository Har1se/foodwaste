...
PRODUCTS = [
    ...
    # ── Бесплатно (FREE) ───────────────────────────────────────────────────────
    {
        ...
        "allergens": ["gluten"],
        # Unique sourdough bread photo (different from "Корзинка выпечки")
...
def _pickup_window(now: datetime, start_hours: float, duration_hours: float):
    """Return (start, end) tuple for a realistic same-day pickup window."""
    return (
...
# How long each listing is available (start_hours, duration_hours)
# Indexed in sync with PRODUCTS list
_WINDOWS = [
    (0.5, 5), (0.5, 4), (0.5, 4), (1, 5), (1, 5), (1, 5),   # 0-5  суши, ролл, рамен, гёдза, стейк, ланч-бокс
    (0.5, 6), (0.5, 5), (0.5, 5), (1, 5), (0.5, 4), (1, 5),  # 6-11 плов, манты, лагман, бургер, сэндвич, буррито
    (0.5, 4), (1, 4),                                          # 12-13 шаурма, фалафель
    (0.5, 5), (1, 5), (0.5, 6),                               # 14-16 поке, боул, смузи
    (0.5, 4), (1, 5), (1, 5), (0.5, 3), (0.5, 4),             # 17-21 выпечка, торт, чизкейк, панкейки, пончики
    (1, 5), (1, 4), (0.5, 5), (0.5, 4),                       # 22-25 стейк, рыба, курица, суп
    (0.5, 5), (0.5, 4), (1, 5), (1, 5), (0.5, 4), (0.5, 4),  # 26-31 ланч-боксы, десерты
    (1, 5), (1, 5), (0.5, 4),                                  # 32-34 тай
    (1, 5), (0.5, 4), (1, 5),                                  # 35-37 индия
    (1, 5), (0.5, 5),                                          # 38-39 корея
    (0.5, 5), (0.5, 4),                                        # 40-41 грузия
    (1, 5), (0.5, 4),                                          # 42-43 мексика
    (0.5, 3), (0.5, 3), (0.5, 3),                             # 44-46 завтраки
    (0.5, 5), (0.5, 6),                                        # 47-48 напитки
    (0.5, 3), (0.5, 2), (0.5, 3),                             # 49-51 скидки 70%
    (0, 2), (0, 2), (0, 2),                                   # 52-54 бесплатно
]
...
async def auto_seed(session: AsyncSession) -> int:
    ...
    for i, raw in enumerate(PRODUCTS):
        ...
        start_h, dur_h = _WINDOWS[i] if i < len(_WINDOWS) else (0.5, 5)
        p_start, p_end = _pickup_window(now, start_h, dur_h)
